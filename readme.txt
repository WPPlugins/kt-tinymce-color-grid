...
= 1.9 =
- Added transparency/opacity support for [Elementor Page Builder](http://wordpress.org/plugins/elementor).
- Generates a name for new or unnamed colors. Thanks to Chirag Mehta, http://chir.ag/projects/ntc
...
= 1.9 =
RGBA/Transparency support for Elementor; generates names for unnamed colors
